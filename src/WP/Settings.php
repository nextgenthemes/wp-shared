...
class Settings {
	...
	public function set_defined_product_keys() {
		...
		foreach ( $products as $p => $value ) {
			$defined_key = \Nextgenthemes\WP\get_defined_key( $p );
			if ( $defined_key ) {
	...
	public function assets( $page ) {
		...
		enqueue_asset(
			array(
				...
				'src'    => trailingslashit( $this->base_url ) . 'vendor/nextgenthemes/wp-settings/public/build/bundle.css',
				'path'   => trailingslashit( $this->base_path ) . 'vendor/nextgenthemes/wp-settings/public/build/bundle.css',
			)
		);
		...
		enqueue_asset(
			array(
				'handle'               => 'nextgenthemes-settings',
				'src'                  => trailingslashit( $this->base_url ) . 'vendor/nextgenthemes/wp-settings/public/build/bundle.js',
				'path'                 => trailingslashit( $this->base_path ) . 'vendor/nextgenthemes/wp-settings/public/build/bundle.js',
				'deps'                 => array( 'jquery' ),
